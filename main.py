...
def parse_args():
    ...
    parser.add_argument(TEXT, "--text",
                        default="Hello World!",
                        required=False, help="Text to display")
    parser.add_argument(ANIMATION, "--animation",
                        default=None,
                        required=False, help="Animation")
    parser.add_argument(FONT, "--font",
                        default="data/fonts/",
                        required=False, help="Font to use")
    parser.add_argument(STICKER, "--sticker",
                        default="data/stickers/doge.png",
                        required=False, help="Font to use")
    parser.add_argument(PLATFORM, "--platform",
                        default=None,
                        required=False, help="Target platform")
